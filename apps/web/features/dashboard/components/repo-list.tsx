  ...
  if (allRepos.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center bg-[var(--koro-surface-dark-elevated)] border border-[var(--koro-hairline-strong)] rounded-xl">
        ...
        <p className="text-[var(--koro-ash)] text-sm max-w-sm">
          We couldn't find any repositories connected to your GitHub App installation.
        </p>
      </div>
    );
  }
      ...
      <div className="flex flex-col gap-3">
        {filteredRepos.length === 0 ? (
          <div className="flex flex-col items-center justify-center p-12 text-center border border-dashed border-[var(--koro-hairline-strong)] rounded-xl">
            ...
            <p className="text-[var(--koro-on-primary)] font-medium text-sm">
              No repositories match your filters
            </p>
            <p className="text-[var(--koro-ash)] text-xs mt-1">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1.5">
                      <h3 className="font-semibold text-[var(--koro-on-primary)] tracking-wide">
                        {repo.fullName}
                      </h3>
                    ...
                    <div className="flex items-center gap-3 text-xs font-medium tracking-wide">
                      <div className="flex items-center gap-1.5">
                        ...
                        {!repo.syncStatus && (
                          <Database className="w-3.5 h-3.5 text-[var(--koro-ash)]" />
                        )}
                        ...
                        >
                          {repo.syncStatus
                            ? repo.syncStatus.charAt(0).toUpperCase() + repo.syncStatus.slice(1)
                            : "Unsynced"}
                        </span>
                      </div>
                      {repo.defaultBranch && (
                        <>
                          ...
                          <span className="text-[var(--koro-ash)]">
