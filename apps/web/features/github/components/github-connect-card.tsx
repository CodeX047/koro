        ...
        <div className="flex items-start gap-5">
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              <h2 className="text-xl font-semibold text-[var(--koro-on-primary)]">GitHub App</h2>
              {connected ? (
            ...
            {connected ? (
              <p className="text-[var(--koro-ash)] text-sm leading-relaxed max-w-lg">
                Installed and active for{" "}
                <span className="font-semibold text-[var(--koro-on-primary)]">@{accountLogin}</span>
                . Kōro is continuously monitoring your repositories for new pull requests and
                codebase updates.
              </p>
            ) : (
              <p className="text-[var(--koro-ash)] text-sm leading-relaxed max-w-lg">
                Install the Kōro GitHub app to authorize repository access. This allows us to read
                your code and post AI reviews directly to your pull requests.
              </p>
            )}
          </div>
        </div>
      ...
      {!connected && (
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 pt-8 border-t border-[var(--koro-hairline-strong)]">
          <div className="flex flex-col gap-2">
            ...
            <h3 className="text-sm font-medium text-[var(--koro-on-primary)]">
              Granular Permissions
            </h3>
            <p className="text-xs text-[var(--koro-ash)] leading-relaxed">
              You choose exactly which repositories Kōro can access. We only ask for the minimum
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-[var(--koro-ash)] leading-relaxed">
              Reviews are posted directly to your GitHub PRs, right where your developers already
              work.
            </p>
          </div>
        </div>
