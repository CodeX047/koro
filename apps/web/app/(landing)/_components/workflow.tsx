...
export function Workflow() {
    ...
    return (
      ...
      >
        <div
          ...
          style={{ color: "var(--koro-ash)", opacity: 0.8 }}
        >
          0{index + 1}
        </div>
  ...
  return (
    <section id="workflow" className="px-6" style={{ paddingTop: "var(--koro-section)" }} ref={ref}>
      <div className="mx-auto max-w-[960px]">
        ...
        >
          From repository connection to production merge. Kōro seamlessly integrates into your
        ...
        <div className="mt-16 w-full hidden md:grid grid-cols-[1fr_auto_1fr_auto_1fr] gap-x-4 gap-y-6 items-center">
          ...
          <div className="col-start-2 row-start-1 flex justify-center text-[var(--koro-ash)] font-mono">
            ──►
          </div>
          <div className="col-start-3 row-start-1">{renderCard(1)}</div>
          <div className="col-start-4 row-start-1 flex justify-center text-[var(--koro-ash)] font-mono">
            ──►
          </div>
          ...
          <div className="col-start-4 row-start-3 flex justify-center text-[var(--koro-ash)] font-mono">
            ◄──
          </div>
          <div className="col-start-3 row-start-3">{renderCard(4)}</div>
          <div className="col-start-2 row-start-3 flex justify-center text-[var(--koro-ash)] font-mono">
            ◄──
          </div>
