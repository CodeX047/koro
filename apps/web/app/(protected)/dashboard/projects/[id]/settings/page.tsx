...
export default function ProjectSettingsPage() {
  ...
  const { data: connectedRepo, isLoading: connectedRepoLoading } =
    trpc.github.getConnectedRepository.useQuery({ projectId });
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-8 font-sans text-slate-100">
      <div
        className="flex flex-col gap-1 pb-4 border-b border-dashed"
      ...
      >
        ...
        {connectedRepo ? (
          <div className="space-y-4">
            <div
              className="flex items-center gap-2 text-green-400 p-4 rounded-sm border"
              style={{
            ...
            >
              ...
              <div>
                <p className="text-[12px] font-semibold">
                  Connected to {connectedRepo.owner}/{connectedRepo.name}
                </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-4">
              ...
              >
                ...
                <div
                  className="font-bold text-[12px] mt-1"
                  style={{ color: "var(--koro-on-primary)" }}
                >
                  Connected
                </div>
              ...
              >
                ...
                <div
                  ...
                  style={{ color: "var(--koro-on-primary)" }}
                >
                  {connectedRepo.updatedAt
                    ? new Date(connectedRepo.updatedAt).toLocaleDateString()
                    : "Just now"}
                </div>
              </div>
              <div
          ...
          <div className="space-y-4">
            <p className="text-[12px]" style={{ color: "var(--koro-ash)" }}>
              Connect a GitHub repository to track development events and sync issues.
            </p>
            ...
            {!reposLoading && availableRepos?.length === 0 && (
              <div className="flex items-center gap-2 text-yellow-500 bg-yellow-500/10 p-3 rounded-sm border border-yellow-500/20 mt-4 text-[11px]">
                ...
                <p>
                  No repositories found. Make sure the Kōro GitHub App is installed and has access
