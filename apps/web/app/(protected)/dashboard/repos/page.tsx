    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Repositories accessible by the Koro GitHub App. You can sync their codebases to improve AI
          review quality.
        </p>
        {isSyncLimitReached && (
          <div className="mt-2 text-sm text-yellow-600 bg-yellow-500/10 border border-yellow-500/20 rounded-md p-3">
            You are on the Free plan, which allows syncing only 1 repository. Upgrade your plan to
            sync more repositories.
          </div>
        )}
      </div>
