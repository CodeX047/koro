...
program.command("activate <license-key>").description("Activate your license").action(activate);

program.command("deactivate").description("Deactivate license on this device").action(deactivate);
